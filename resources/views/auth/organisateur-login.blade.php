@extends('layouts.app')
@section('title','Connexion Organisateur')
@section('styles')
<style>
            ...
            <div class="login-card">
                <div class="row no-gutters">
                    <div class="col-md-5 login-left">
                        ...
                        <h3 class="font-weight-bold">Espace Organisateur</h3>
                        <p style="opacity:0.85">Gérez vos événements et suivez vos ventes.</p>
                        <hr style="border-color:rgba(255,255,255,0.3)">
                        <p class="small" style="opacity:0.8">Pas encore de compte ?</p>
                        <a href="{{ route('organisateur.register') }}" class="btn btn-light btn-sm rounded-pill font-weight-bold">S'inscrire gratuitement</a>
                    </div>
                    <div class="col-md-7 login-right">
                        <h4 class="font-weight-bold mb-1">Connexion Organisateur</h4>
                        <p class="text-muted small mb-4">Accédez à votre tableau de bord.</p>
                        @if(session('error'))
                        ...
                        @endif
                        <form method="POST" action="{{ route('organisateur.login.post') }}">
