...
@section('page-title','Supervision des Paiements')
@section('page-subtitle','Historique complet des transactions')
@section('content')
<div class="row mb-4">
    <div class="col-md-4">
...
<div class="card">
    <div class="card-header bg-dark text-white"><i class="fas fa-credit-card mr-2"></i>Transactions ({{ $paiements->total() }})</div>
    <div class="card-body p-0">
        <div class="table-responsive">
            <table class="table table-hover mb-0">
                <thead>
                    <tr><th>Réf.</th><th>Client</th><th>Événement</th><th>Montant</th><th>Méthode</th><th>Statut</th><th>Date</th></tr>
                </thead>
                <tbody>
                    @forelse($paiements as $p)
                    <tr>
                        <td><code class="small">{{ $p->reference ? $p->reference : 'N/A' }}</code></td>
                        ...
                        <td class="font-weight-bold">{{ number_format($p->montant, 0, '.', ' ') }} DJF</td>
                    ...
                    @empty
                    <tr><td colspan="7" class="text-center py-4 text-muted">Aucune transaction.</td></tr>
                    @endforelse
                </tbody>
            </table>
        </div>
